const VelocityFrameWorkData = [
    {
        ...
        points: [
            "Geo-Targeted Awareness Ads films",
            "Hyperlocal & Location-Based Content",
